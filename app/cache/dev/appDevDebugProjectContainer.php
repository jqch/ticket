...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Servicios\ControlTickets A AppBundle\Servicios\ControlTickets instance
     */
    protected function getCtService()
    {
        return $this->services['ct'] = new \AppBundle\Servicios\ControlTickets();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_96423fbc8e9ec47f170f58b2be73859c7c0f3525b12bc78b2e8deb5525cbfd2c');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57e01003537c03.01026404')), true);
